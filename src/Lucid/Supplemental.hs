...
-- This file was copied from https://github.com/alogic0/lucid-from-html/blob/master/src/Lucid/Supplemental.hs
-- because lucid
...
ionIcon_ :: TermRaw arg result => arg -> result
ionIcon_ = termRaw "ion-icon"
